class Isx < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/isxcode/isx-cli/releases/download/v1.1.5/isx_darwin_arm64", using: :nounzip
      sha256 "e1e497ae228d67b12b24e2239ee556cdf8a8e9cdbc3b8ea9eba85d9d558fbd30"
    end

    on_intel do
      url "https://github.com/isxcode/isx-cli/releases/download/v1.1.5/isx_darwin_amd64", using: :nounzip
  ...
  on_linux do
    on_arm do
      url "https://github.com/isxcode/isx-cli/releases/download/v1.1.5/isx_linux_arm64", using: :nounzip
      sha256 "eeec1284e376824f7c732b35f11821705fab5467d5263f611d88b086352430fe"
    end

    on_intel do
      url "https://github.com/isxcode/isx-cli/releases/download/v1.1.5/isx_linux_amd64", using: :nounzip
